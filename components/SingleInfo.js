    ...
    <div className='md:px-[20%] px-3 py-5'>
        {
            ...
            <div className='md:w-[500px] border-2 text-center shadow-xl rounded-md px-2 md:py-10 my-6 mx-auto'>
                ...
                <div className="info py-5 mt-5 md:px-10 px-2 text-left flex flex-col gap-3">
                    ...
                    <h3 className='md:text-lg text-sm px-2 text-red-500 even:white odd:bg-yellow-50 rounded-lg'>Last Donated : <span className='text-zinc-500 font-normal uppercase'>{singleDonator.lastDonated}</span></h3>
